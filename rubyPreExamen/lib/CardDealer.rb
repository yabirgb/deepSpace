...
=end        
        ...
        @enemies.add(EnemyStarShip.new("Enemigo transforma 0",10,10,transformLoot0,regularDamage0))
        @enemies.add(EnemyStarShip.new("Enemigo transforma 1",10,10,transformLoot1,regularDamage1))
    end
end # class
